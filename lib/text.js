 ...
 * @param {number[]} [options.cmyk] - Array of CMYK colors
...
exports.text = function text(text = '', x, y, options = {}) {
    ...
    toWriteTextObjects.forEach((toWriteTextObject, index) => {
        ...
        const writeText = (context, text, x, y, options) => {
            ...
            if (Array.isArray(targetAnnotations.cmyk) && targetAnnotations.cmyk.length === 4) {
                console.log(targetAnnotations.cmyk[0], targetAnnotations.cmyk[1], targetAnnotations.cmyk[2], targetAnnotations.cmyk[3])
                ...
                xObject
                    ...
                    .BT()
                    .k(targetAnnotations.cmyk[0] / 100, targetAnnotations.cmyk[1] / 100, targetAnnotations.cmyk[2] / 100, targetAnnotations.cmyk[3] / 100)
